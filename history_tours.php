...
$tourFields = array(
	...
	array(
		...
		'type'		=> 'select',
		'options'	=> array(
						array('label'=>'Display all location content inline','name'=>'all'),
						array('label'=>'Display locations as a grid of images','name'=>'gallery'),
						array('label'=>'Display locations as a grid of images – link to individual location pages','name'=>'gallery_linked'),
						array('label'=>'Display locations as list of links','name'=>'links'),
						array('label'=>'Display locations as list of links – with text excerpts','name'=>'links_text'),
						array('label'=>'Display locations as list of links – with text excerpts and thumbnail images','name'=>'links_text_thumbnails'),
						),
		'custom_ui'	=> false,				
